...
namespace TotalPotato
{
    ...
    {
        void CreateStream([MarshalAs(21)][In] string pwcsName, [In] uint grfMode, [In] uint reserved1, [In] uint reserved2, [MarshalAs(28)] out IStreamCom ppstm);
        void OpenStream([MarshalAs(21)][In] string pwcsName, [In] nint reserved1, [In] uint grfMode, [In] uint reserved2, [MarshalAs(28)] out IStreamCom ppstm);
        ...
        void OpenStorage([MarshalAs(21)][In] string pwcsName, [MarshalAs(28)][In] IStorage pstgPriority, [In] uint grfMode, [In] nint snbExclude, [In] uint reserved, [MarshalAs(28)] out IStorage ppstg);
        void CopyTo([In] uint ciidExclude, [MarshalAs(42, SizeParamIndex = 0)][In] Guid[] rgiidExclude, [In] nint snbExclude, [MarshalAs(28)][In] IStorage pstgDest);
        ...
        void Revert();
        void EnumElements([In] uint reserved1, [In] nint reserved2, [In] uint reserved3, [MarshalAs(28)] out IEnumSTATSTG ppEnum);
