...
namespace TotalPotato
{
    ...
    internal class StorageTrigger : IMarshal, IStorage
    {
        ...
        public void MarshalInterface(IStreamCom pstm, ref Guid riid, IntPtr pv, uint dwDestContext, IntPtr pvDestContext, uint MSHLFLAGS)
        {
        ...
        public void ReleaseMarshalData(IStreamCom pstm)
        {
        }

        public void UnmarshalInterface(IStreamCom pstm, ref Guid riid, out IntPtr ppv)
        {
            ppv = IntPtr.Zero;
        }
        ...
        public void CreateStream(string pwcsName, uint grfMode, uint reserved1, uint reserved2, out IStreamCom ppstm)
        {
        ...
        public void OpenStream(string pwcsName, IntPtr reserved1, uint grfMode, uint reserved2, out IStreamCom ppstm)
        {
